...
const browserUsers: BrowserUser[] = [
  ...
  { id: 'browser-inscripcion-aux-1', username: 'inscripcion.auxiliar.1', displayName: 'Auxiliar de Inscripcion 1', role: 'INSCRIPCION_AUX', departmentId: 'browser-dept-control', departmentName: 'Control Escolar', isActive: true, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString(), password: 'Inscripcion123!' },
