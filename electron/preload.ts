...
contextBridge.exposeInMainWorld('cbta', {
  ...
  students: {
    ...
    reinscribeForPeriod: (input: unknown) => ipcRenderer.invoke('students:reinscribeForPeriod', input),
  ...
  groups: {
    ...
    updateAdvisor: (input: unknown) => ipcRenderer.invoke('groups:updateAdvisor', input),
